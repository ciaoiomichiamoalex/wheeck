...
def doc_scanner(working_doc: str, job_begin: datetime = datetime.now()) -> tuple[int, int]:
    ...
    for working_page, page in enumerate(doc, start=1):
        ...
        if search:
            ...
            logger.error('discarding page %d of %s for error on PATTERN_DOC_NUMBER...', working_page, working_doc_name)
        ...
        if search:
            ...
            logger.warning('error on PATTERN_CITY_DX on page %d of %s... moving on PATTERN_CITY_SX!', working_page, working_doc_name)
